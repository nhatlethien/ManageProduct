...
public class ProductController {
	...
	@ModelAttribute("categories") //lựa chọn danh mục cho sản phẩm
	...
	public ModelAndView edit(ModelMap model, @PathVariable("productId") Long productId) {
		...
		model.addAttribute("message", "Không tìm thấy product");
	...
	public ModelAndView delete(ModelMap model, 
		...
		if (opt.isPresent()) {
			...
			model.addAttribute("message", "không tìm thấy found");
		}
	...
	public ModelAndView saveOrUpdate(ModelMap model,
		...
		return new ModelAndView("forward:/admin/products", model) ; //forward chuyển hướng đến list
	}
